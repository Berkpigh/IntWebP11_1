    ...
    <React.Fragment>
      ...
      <div className="min-h-80vh">
        ...
        <div className="z-0 min-h-55vh h-300px mdpb:h-400px bg-[0_-50px] mdpb:bg-[0_33%] bg-hero object-cover bg-cover bg-no-repeat relative">
          {/* Hero-content */}
          <div className="z-10 bg-fff relative mdpb:absolute inset-y-8 mdpb:top-[50px] mdpb:right-[50px] w-250px mdpb:w-364px mdpb:h-224px  p-2rem  text-left mx-auto mr-auto mdpb:m-8">
